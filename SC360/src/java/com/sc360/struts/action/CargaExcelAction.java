    ...
    public ActionForward cargaExcel(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res)
        ...
        if (tipoArchivo.equals("1")) {
            ...
            try {
                ...
                //int numLineas=9;
                int numLineas = 9;
                for (TipoArchivo archivo1 : listTipoArchivo) {
                    if (archivo1.getDescripcion().equals("1")) {
                        numLineas = archivo1.getNumfila();
                    }
                }

                /*Optional<TipoArchivo> archivo1 = listTipoArchivo.stream().filter( a -> a.getDescripcion().equals("1")).findFirst();
                        
                        TipoArchivo archivo2 = archivo1.get();
                        
                        
                        numLineas = archivo2.getNumfila();*/
                int contador = 0;
 ...
 /*int n1;
        ...
        if (tipoArchivo.equals("2")) {
            ...
            try {
                ...
                int numLineas = 2;
                for (TipoArchivo archivo2 : listTipoArchivo) {
                    if (archivo2.getDescripcion().equals("2")) {
                        numLineas = archivo2.getNumfila();
                    }
                }
                int contador = 0;
        ...
        if (tipoArchivo.equals("3")) {
            ...
            try {
                ...
                int numLineas = 13;
                for (TipoArchivo archivo3 : listTipoArchivo) {
                    if (archivo3.getDescripcion().equals("13")) {
                        numLineas = archivo3.getNumfila();
                    }
                }
                int contador = 0;
        ...
        if (tipoArchivo.equals("4")) {
            ...
            try {
                ...
                int numLineas = 0;
                for (TipoArchivo archivo4 : listTipoArchivo) {
                    if (archivo4.getDescripcion().equals("4")) {
                        numLineas = archivo4.getNumfila();
                    }
                }
                int contador = 0;
